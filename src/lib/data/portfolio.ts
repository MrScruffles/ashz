...
export const items: Array<Project> = [
  {
    ...
    links: [      
      ...
      { to: 'https://raw.githubusercontent.com/MrScruffles/ashz/main/static/screenshots/Project2/Project_2_Ash_Zahabiuon.ipynb', label: 'Jupiter Notebook File (Download)' }
